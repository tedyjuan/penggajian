...
class M_pendidikan extends CI_Model {
    ...
    public function __construct() {
        parent::__construct();
        $this->table = "m_pendidikan"; //setting di dalam $this->table dalah nama tabel sesuai di databasenya
        $this->prefix_id = "id_pendidikan"; //setting di dalam $this->prefix_id adalah primary key di tabel
    }
    ...
    function checkData($param) {
        $this->db->where("nama_pendidikan", $param);
