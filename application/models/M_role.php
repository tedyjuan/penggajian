...
class M_role extends CI_Model {
    ...
    public function __construct() {
        parent::__construct();
        $this->table = "m_role"; //setting di dalam $this->table dalah nama tabel sesuai di databasenya
        $this->prefix_id = "role_id"; //setting di dalam $this->prefix_id adalah primary key di tabel
    }
