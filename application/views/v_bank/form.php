    ...
    <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_bank">Nama bank<span class="err_type required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="nama_bank" required="required" class="form-control col-md-7 col-xs-12"
                                        ...
                                        function (data, text)
                                        {
                                            if (data.hasil == 'true') {
                                               load_form(urlindex);
                                                ...
                                                $(".err_nama_bank").html(data.err_type).fadeIn('slow');
