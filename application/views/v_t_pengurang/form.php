<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
			...
			<!-- START -->
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_pengurang">Parameter<span class="err_id_pengurang required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select id="id_pengurang" name="id_pengurang" >
                        <?php foreach ($default['id_pengurang'] as $row) { ?>
			...
			<div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nilai">Nilai<span class="err_nilai required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        function (data, text)
                                        {
                                            if (data.hasil == 'true') {
                                               load_form(urlindex);
												...
												$(".err_id_pengurang").html(data.err_id_pengurang).fadeIn('slow');
