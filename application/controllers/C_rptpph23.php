...
class C_rptpph23 extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->controller = 'c_rptpph23';
        $this->view = 'v_rptpph23';
    ...
    function exceldata($tanggalproses) {
        ...
        header("Content-Disposition: attachment;filename=\"biayapph23.xlsx\"");
